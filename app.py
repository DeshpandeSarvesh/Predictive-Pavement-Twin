...
with col2:
    ...
    st.info("ℹ️ **Technical Details & Diagnostics Report:** The complete pavement health details (including structural strains, subgrade strength, resilient modulus, and IRC design compliance) are compiled in the PDF report. Please download the PDF below to view the full details.")
    ...
    st.download_button(
        ...
        help="Download the official digital twin pavement diagnostics report PDF"
    )
