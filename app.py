...
def generate_pdf_report(node_name, segment_idx, current_pci, predicted_pci, traffic_vol, cbr_eff, mr_sub, eps_t, eps_v, eps_t_allow, eps_v_allow, nf, nr, forecast_horizon):
    ...
    header_data = [
        [
            Paragraph("<b>NMC PWD DIGITAL TWIN PATHOLOGY LAB</b><br/><font size=9 color='#0070FF'>Predictive Diagnostics & Infrastructure Health Monitoring</font>", title_style),
    ...
    profile_data = [
        ...
        [
            ...
            Paragraph("Referred By:", meta_label_style), Paragraph("PWD GNN Diagnostics Engine", meta_val_style)
        ],
        [
    ...
    # 3. COMPLETE PAVEMENT COUNT (CPC) TABLE
    ...
    # Row contents: Investigation, Result, Flag/Status, Reference Range, Unit
    table_rows = [
        [
            ...
            Paragraph("<b>Reference Value (IRC)</b>", table_cell_bold_style),
        ...
        [
            Paragraph(f"<b>Predicted PCI (at {forecast_horizon} months)</b>", table_cell_style),
        ...
        [
            Paragraph("<b>Tensile Strain (at bottom of Asphalt - ε_t)</b>", table_cell_style),
            ...
            Paragraph("με (microstrain)", table_cell_style)
        ],
        [
            Paragraph("<b>Compressive Strain (top of Subgrade - ε_v)</b>", table_cell_style),
        ...
        [
            ...
            Paragraph("MSA (Million Axles)", table_cell_style)
        ]
    ]
    
    cpc_table = Table(table_rows, colWidths=[190, 72, 80, 130, 60])
    ...
    sig_data = [
        [
            Paragraph("<b>Digitally Signed</b><br/><font size=8 color='#555'>AI GNN Diagnostic Engine<br/>NMC PWD Digital Twin System</font>", table_cell_style),
            Paragraph("<b>Verified Compliance</b><br/><font size=8 color='#555'>IRC:37-2018 Physics Engine<br/>Mechanistic-Empirical Design Checker</font>", table_cell_style)
        ]
    ]
